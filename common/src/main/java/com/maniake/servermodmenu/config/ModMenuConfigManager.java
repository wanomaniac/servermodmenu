package com.maniake.servermodmenu.config;

import com.google.common.collect.Sets;
import com.google.gson.*;
import com.maniake.servermodmenu.Constants;
import com.maniake.servermodmenu.config.option.ConfigOptionStorage;
import com.maniake.servermodmenu.config.option.BooleanConfigOption;
import com.maniake.servermodmenu.config.option.EnumConfigOption;
import com.maniake.servermodmenu.config.option.StringSetConfigOption;
...
public class ModMenuConfigManager {
	...
	private static void prepareConfigFile() {
		...
		file = new File(Constants.modVersion.getConfigDir(), Constants.MOD_ID + ".json");
	}
	...
	public static void save() {
		...
		String jsonString = Constants.GSON.toJson(config);
