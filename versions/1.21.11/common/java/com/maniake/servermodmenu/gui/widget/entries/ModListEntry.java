...
public class ModListEntry extends ObjectSelectionList.Entry<ModListEntry> {
    ...
    public static final Identifier DOWNLOAD_ICON = Identifier.parse("servermodmenu:textures/gui/download_button.png");
    public static final Identifier RELOAD_ICON = Identifier.parse("servermodmenu:textures/gui/reload_servers.png");
    public static final Identifier HIDE_ICON = Identifier.parse("servermodmenu:textures/gui/hide_button.png");
    //private static final Identifier MOD_CONFIGURATION_ICON = new Identifier("servermodmenu", "textures/gui/mod_configuration.png");
    private static final Identifier ERROR_ICON = Identifier.parse("minecraft:textures/gui/world_selection.png");
