...
public class ModsScreen extends Screen {
	private static final Identifier FILTERS_BUTTON_LOCATION = Identifier.parse(Constants.MOD_ID+":"+"textures/gui/filters_button.png");
	private static final Identifier DOWNLOSD_BUTTON_LOCATION = Identifier.parse(Constants.MOD_ID+":"+"textures/gui/download_button.png");
	private static final Identifier RELOADS_BUTTON_LOCATION = Identifier.parse(Constants.MOD_ID+":"+"textures/gui/reload_servers.png");
	...
	public boolean mouseClicked(MouseButtonEvent button, boolean something) {
		if (button.button() == 0 && selected == null) { // left click
			...
			boolean clicked =
				button.x() >= x &&
                        button.x() <= x + textWidth &&
                        button.y() >= y &&
                        button.y() <= y + font.lineHeight;
		...
		return super.mouseClicked(button, something);
	}
