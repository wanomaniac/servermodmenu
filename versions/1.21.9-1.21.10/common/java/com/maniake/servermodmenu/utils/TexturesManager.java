...
public class TexturesManager {
	public static ResourceLocation lFromBase64(String base64, String texturePath) {
		...
		try {
			...
			texture = new DynamicTexture(() -> ResourceLocation.parse(Constants.MOD_ID+":"+texturePath).toString(), nativeImage);

			// Create an Identifier for the texture
			ResourceLocation textureIdentifier = ResourceLocation.parse(Constants.MOD_ID+":"+texturePath);
