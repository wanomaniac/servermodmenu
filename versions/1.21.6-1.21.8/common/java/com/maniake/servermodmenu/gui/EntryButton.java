...
public class EntryButton {
	...
	public EntryButton(ResourceLocation text, Consumer<EntryButton> cb){
		this.Texture = text;
		this.callback = cb;
	}

	public EntryButton(ResourceLocation text, Consumer<EntryButton> cb, int X, int Y, int XS, int XY){
		this.Texture = text;
		this.callback = cb;
		this.ButtonX = X;
		this.ButtonY = Y;
