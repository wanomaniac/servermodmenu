...
//		}
    ...
    public void render(GuiGraphics guiGraphics, int index, int cY, int cX, int rowWidth, int rowHeight, int mouseX, int mouseY, boolean hovered, float delta) {
...
//        int rowWidth = this.list.getRowWidth();
        ...
        if (isFirst) {
            ...
            testB.ButtonX = x + client.font.width(svName) + 15;
            reloadB.ButtonX = x + client.font.width(svName) + 35;
            hideB.ButtonX = x + client.font.width(svName) + 55;
            int wa = y - 12;
//            if (moreY) {
//                wa = wa + 12;
//            }
            ...
            if (!renderSvnNO) {
                testB.render(guiGraphics, mouseX, mouseY);
            }
            reloadB.render(guiGraphics, mouseX, mouseY);
            hideB.render(guiGraphics,mouseX, mouseY);
